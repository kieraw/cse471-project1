...
Right click on project (Synthie) and select Properies then change the top dropdown to Debug, then go into Debugging under Configuration Properties and change the Working Directory to $(SolutionDir) instead of $(ProjectDir).
